                            ...
                            <ul class="dropdown-menu dropdown-navbar">
                                <li>
                                    <a href="#" class="clearfix">
                                        <?= $this->Html->image('/images/avatars/avatar.png',['class'=>'msg-photo', 'alt'=>'Alex\'s Avatar'])?>
                                        <span class="msg-body">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <?= $this->Html->image('/images/avatars/avatar3.png',['class'=>'msg-photo','alt'=>'Susan\'s Avatar'])?>
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <?= $this->Html->image('/images/avatars/avatar4.png',['class'=>'msg-photo', 'alt'=>'Bob\'s Avatar'])?>
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <?= $this->Html->image('/images/avatars/avatar2.png',['class'=>'msg-photo', 'alt'=>'Kate\'s Avatar'])?>
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <?= $this->Html->image('/images/avatars/avatar5.png',['class'=>'msg-photo', 'alt'=>'Fred\'s Avatar'])?>
                                        <span class="msg-body">
													<span class="msg-title">
