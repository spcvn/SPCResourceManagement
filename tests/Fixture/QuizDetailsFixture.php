 ...
 *
 */
class QuizDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_correct' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'sort' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['quiz_id', 'question_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
